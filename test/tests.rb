...
class TestExtractor < MiniTest::Unit::TestCase
  ...
  def test_diputados_voting_record
    ...
    characters = character_extractor.extract.first.get_text_by_area(269.875, 12.75, 790.5, 561)
  ...
  def test_bo_page24
    ...
    characters = character_extractor.extract.first.get_text_by_area(435.625, 53.125, 570.7142857142857, 810.5357142857142)
